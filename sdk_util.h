...
public:
	...
	virtual void onGetInviteEmailContent(ZOOM_SDK_NAMESPACE::PremeetingAPIResult result, UINT64 meetingUniqueID, const wchar_t* content)
	{
		Call_SINK_Pool(ZOOM_SDK_NAMESPACE::IPreMeetingServiceEvent, _premeeting_service_event_pool, onGetInviteEmailContent(result, meetingUniqueID, content))
	}
	//IMeetingAudioCtrlEvent
